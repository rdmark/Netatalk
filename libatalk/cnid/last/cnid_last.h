...
extern cnid_t cnid_last_add(struct _cnid_db *, const struct stat *,
			    const cnid_t, const char *, const size_t,
			    cnid_t);
extern cnid_t cnid_last_get(struct _cnid_db *, const cnid_t, char *,
			    const size_t);
extern char *cnid_last_resolve(struct _cnid_db *, cnid_t *, void *,
			       size_t);
extern cnid_t cnid_last_lookup(struct _cnid_db *, const struct stat *,
			       const cnid_t, char *, const size_t);
extern int cnid_last_update(struct _cnid_db *, const cnid_t,
			    const struct stat *, const cnid_t, char *,
			    size_t);
