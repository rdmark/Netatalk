...
static const u_int16_t mac_chinese_trad_2uni_pagea1[][2] = {
	/* 0xa14 */ { 0xe820, 7 }, { 0x041f, 12 }, { 0x0000, 0 }, { 0x6000,
								   18 },
	/* 0xa18 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x001e, 20 }, { 0x0000,
								   0 },
	/* 0xa1c */ { 0x0828, 24 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x4004,
								   27 },
	/* 0xa20 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa24 */ { 0x0001, 29 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0200,
								   30 },
	/* 0xa28 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa2c */ { 0x5000, 31 },
};
