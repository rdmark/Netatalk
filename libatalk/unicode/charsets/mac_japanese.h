...
static const u_int16_t mac_japanese_uni2_page20[][2] = {
	...
	/* 0x204 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x208 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x20c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x210 */ { 0x0200, 6 }, { 0x0048, 7 }, { 0x0006, 9 }, { 0x0000,
								  0 },
	/* 0x214 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0fff, 11 }, { 0x0fff,
								   23 },
	/* 0x218 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x21c */ { 0x0070, 35 }, { 0x0000, 0 }, { 0x03c0, 38 },
	    { 0x0000, 0 },
	/* 0x220 */ { 0x0000, 0 }, { 0x8000, 42 }, { 0x4000, 43 },
	    { 0x0000, 0 },
	/* 0x224 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x228 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x8000,
								  44 },
};

static const u_int16_t mac_japanese_uni2_page24[][2] = {
	/* 0x246 */ { 0xffff, 45 }, { 0xffff, 61 },
	/* 0x248 */ { 0xffff, 77 }, { 0xf001, 93 }, { 0xffff, 98 },
	    { 0x003f, 114 },
};

static const u_int16_t mac_japanese_uni2_page26[][2] = {
	/* 0x260 */ { 0x4000, 120 }, { 0xf000, 121 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0x264 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x00ff, 125 },
	    { 0x0000, 0 },
	/* 0x268 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x26c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x270 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x274 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x7fc0,
								  133 },
};

static const u_int16_t mac_japanese_uni2_page30[][2] = {
	/* 0x300 */ { 0x0010, 142 }, { 0xa000, 143 }, { 0x0001, 145 },
	    { 0x0000, 0 },
	/* 0x304 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x308 */ { 0x0000, 0 }, { 0x0010, 146 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0x30c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0780,
								  147 },
};

static const u_int16_t mac_japanese_uni2_page32[][2] = {
	/* 0x322 */ { 0xfc00, 151 }, { 0xffff, 157 },
	/* 0x324 */ { 0x000d, 173 }, { 0x0000, 0 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0x328 */ { 0x0000, 0 }, { 0x6340, 176 }, { 0x03f0, 181 },
	    { 0x0000, 0 },
	/* 0x32c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x330 */ { 0x2029, 187 }, { 0x4170, 191 }, { 0x0ccc, 196 },
	    { 0x0a4a, 202 },
	/* 0x334 */ { 0x6684, 207 }, { 0x0082, 213 }, { 0x0000, 0 },
	    { 0xf800, 215 },
	/* 0x338 */ { 0xc0e0, 220 }, { 0xf1c1, 225 }, { 0x0037, 233 },
	    { 0x000f, 238 },
	/* 0x33c */ { 0x2810, 242 }, { 0x0010, 245 },
};

static const u_int16_t mac_japanese_uni2_pagee0[][2] = {
	/* 0xe00 */ { 0xffff, 246 }, { 0xffff, 262 }, { 0x0fff, 278 },
	    { 0x001f, 290 },
	/* 0xe04 */ { 0x7f00, 295 },
};
...
static const u_int16_t mac_japanese_2uni_page00[][2] = {
	/* 0x008 */ { 0x0001, 0 }, { 0x0000, 0 }, { 0x0001, 1 }, { 0x0000,
								  0 },
...
static const u_int16_t mac_japanese_2uni_page85[][2] = {
	/* 0x854 */ { 0xffff, 7 }, { 0xc00f, 23 }, { 0xffff, 29 },
	    { 0x7003, 45 },
	/* 0x858 */ { 0x003f, 50 }, { 0x87fe, 56 }, { 0x3fff, 67 },
	    { 0xfff8, 81 },
	/* 0x85c */ { 0x0003, 94 }, { 0xf800, 96 }, { 0xffff, 101 },
	    { 0x001f, 117 },
	/* 0x860 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x864 */ { 0xffff, 122 }, { 0x3fff, 138 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0x868 */ { 0x0000, 0 }, { 0xf800, 152 }, { 0x007f, 157 },
	    { 0x0038, 164 },
	/* 0x86c */ { 0xff80, 167 }, { 0x007f, 176 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0x870 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x874 */ { 0xffff, 183 }, { 0x01ff, 199 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0x878 */ { 0x0000, 0 }, { 0xfffe, 208 }, { 0xffff, 223 },
	    { 0xe03f, 239 },
	/* 0x87c */ { 0x0003, 248 }, { 0x0000, 0 }, { 0x01e0, 250 },
	    { 0x1c00, 254 },
	/* 0x880 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x884 */ { 0x0007, 257 }, { 0x0030, 260 }, { 0x3d00, 262 },
};

static const u_int16_t mac_japanese_2uni_pageeb[][2] = {
	/* 0xeb4 */ { 0x0006, 267 }, { 0x3803, 269 }, { 0xfe1f, 274 },
	    { 0x07ff, 286 },
	/* 0xeb8 */ { 0x0002, 297 }, { 0x0000, 0 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xebc */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xec0 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xec4 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xec8 */ { 0x0000, 0 }, { 0x8000, 298 }, { 0x00aa, 299 },
	    { 0x0000, 0 },
	/* 0xecc */ { 0x0002, 303 }, { 0x0000, 0 }, { 0x102a, 304 },
	    { 0x0000, 0 },
	/* 0xed0 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xed4 */ { 0x0155, 308 }, { 0x0000, 0 }, { 0x0004, 313 },
	    { 0x0000, 0 },
