...
static const u_int16_t mac_korean_uni2_page02[][2] = {
	/* 0x02b */ { 0x1000, 11 },
	/* 0x02c */ { 0x0000, 0 }, { 0x1001, 12 }, { 0x0000, 0 }, { 0x0000,
								   0 },
	/* 0x030 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x034 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x038 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
...
static const u_int16_t mac_korean_uni2_page20[][2] = {
	...
	/* 0x204 */ { 0x7284, 29 }, { 0x0002, 35 }, { 0x0000, 0 },
	    { 0x7c00, 36 },
	/* 0x208 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x1200, 41 }, { 0x0000,
								   0 },
	/* 0x20c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x210 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x214 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x218 */ { 0x0000, 0 }, { 0x3000, 43 }, { 0x0000, 0 }, { 0x10df,
								   45 },
	/* 0x21c */ { 0xa031, 53 }, { 0x0001, 58 }, { 0x03cf, 59 },
	    { 0x0001, 67 },
	/* 0x220 */ { 0x1240, 68 }, { 0x8008, 71 }, { 0x0064, 73 },
	    { 0x1080, 76 },
	/* 0x224 */ { 0x0128, 78 }, { 0x040b, 81 }, { 0xccc4, 85 },
	    { 0x0ecf, 92 },
	/* 0x228 */ { 0x0033, 101 }, { 0x02e0, 105 }, { 0x0018, 109 },
	    { 0x1800, 111 },
	/* 0x22c */ { 0xc000, 113 }, { 0x0c00, 115 }, { 0x4000, 117 },
	    { 0x0000, 0 },
...
static const u_int16_t mac_korean_uni2_page24[][2] = {
	...
	/* 0x248 */ { 0x00f8, 125 }, { 0x0000, 0 }, { 0x0000, 0 },
	    { 0xffc0, 130 },
	/* 0x24c */ { 0xffff, 140 }, { 0x0000, 0 }, { 0xf800, 156 },
	    { 0x001f, 161 },
	/* 0x250 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x254 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x258 */ { 0x0100, 166 }, { 0x0000, 0 }, { 0x2004, 167 },
	    { 0x8222, 169 },
	/* 0x25c */ { 0x3608, 173 }, { 0x0000, 0 }, { 0x8040, 178 },
	    { 0x1800, 180 },
	/* 0x260 */ { 0x0000, 0 }, { 0xa001, 182 }, { 0x8000, 185 },
	    { 0x0000, 0 },
	/* 0x264 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x8040, 186 },
	    { 0x0000, 0 },
	/* 0x268 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x26c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x270 */ { 0x0000, 0 }, { 0x0440, 188 }, { 0x0009, 190 },
	    { 0xa002, 192 },
	/* 0x274 */ { 0x2083, 195 }, { 0x0040, 199 }, { 0x0000, 0 },
	    { 0xffc0, 200 },
	/* 0x278 */ { 0xfc00, 210 }, { 0x581f, 216 }, { 0x0012, 224 },
	    { 0x0024, 226 },
};

static const u_int16_t mac_korean_uni2_page29[][2] = {
	/* 0x293 */ { 0x02f0, 228 },
	/* 0x294 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x003c, 233 },
	    { 0x0000, 0 },
	/* 0x298 */ { 0x0062, 237 }, { 0x0180, 240 }, { 0x0008, 242 },
	    { 0xc000, 243 },
	/* 0x29c */ { 0x0100, 245 }, { 0x0000, 0 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0x2a0 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0040, 246 },
	    { 0x0100, 247 },
	/* 0x2a4 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0004,
								  248 },
	/* 0x2a8 */ { 0x1800, 249 }, { 0x0006, 251 }, { 0x0000, 0 },
	    { 0x0000, 0 },
...
static const u_int16_t mac_korean_uni2_page32[][2] = {
	/* 0x323 */ { 0x0202, 268 },
	/* 0x324 */ { 0x0000, 0 }, { 0x07fe, 270 }, { 0x0000, 0 },
	    { 0x0000, 0 },
...
static const u_int16_t mac_korean_uni2_pagee0[][2] = {
	/* 0xe00 */ { 0xffff, 291 }, { 0xffff, 307 }, { 0xffff, 323 },
	    { 0xffff, 339 },
	/* 0xe04 */ { 0xffff, 355 }, { 0xffff, 371 }, { 0xffff, 387 },
	    { 0xffff, 403 },
	/* 0xe08 */ { 0xffff, 419 }, { 0xffff, 435 }, { 0xffff, 451 },
	    { 0xffff, 467 },
	/* 0xe0c */ { 0xffff, 483 }, { 0xffff, 499 }, { 0xffff, 515 },
	    { 0xffff, 531 },
	/* 0xe10 */ { 0xffff, 547 }, { 0xffff, 563 }, { 0xffff, 579 },
	    { 0xffff, 595 },
	/* 0xe14 */ { 0xffff, 611 }, { 0xffff, 627 }, { 0xffff, 643 },
	    { 0xffff, 659 },
	/* 0xe18 */ { 0xffff, 675 }, { 0xffff, 691 }, { 0xffde, 707 },
	    { 0xfff7, 721 },
	/* 0xe1c */ { 0xdfff, 736 }, { 0xffbf, 751 }, { 0xffe7, 766 },
	    { 0xff9f, 780 },
	/* 0xe20 */ { 0xffff, 794 }, { 0xffff, 810 }, { 0xffff, 826 },
	    { 0xffff, 842 },
	/* 0xe24 */ { 0xffff, 858 }, { 0xffff, 874 }, { 0xffff, 890 },
	    { 0xffff, 906 },
	/* 0xe28 */ { 0xffff, 922 }, { 0xffff, 938 }, { 0xffff, 954 },
	    { 0xffff, 970 },
	/* 0xe2c */ { 0xffff, 986 }, { 0x07ff, 1002 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xe30 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0xfffc,
								  1013 },
	/* 0xe34 */ { 0xffff, 1027 }, { 0xffff, 1043 }, { 0xffff, 1059 },
	    { 0xffff, 1075 },
	/* 0xe38 */ { 0xffff, 1091 }, { 0x1fff, 1107 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xe3c */ { 0xfc00, 1120 }, { 0x0000, 0 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xe40 */ { 0x0000, 0 }, { 0x1ffc, 1126 },
};

static const u_int16_t mac_korean_uni2_pagef8[][2] = {
	/* 0xf80 */ { 0x1fe0, 1137 }, { 0x0000, 0 }, { 0x0000, 0 },
	    { 0x2000, 1145 },
	/* 0xf84 */ { 0xffff, 1146 },
};
...
static const u_int16_t mac_korean_uni2_pagefe[][2] = {
	...
	/* 0xfe8 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xfec */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xff0 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xff4 */ { 0x0000, 0 }, { 0x4000, 1164 }, { 0x0000, 0 },
	    { 0x0000, 0 },
...
static const u_int16_t mac_korean_2uni_page00[][2] = {
	/* 0x008 */ { 0x001f, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x00c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x8000,
								  5 },
};

static const u_int16_t mac_korean_2uni_pagea1[][2] = {
	/* 0xa14 */ { 0xfffe, 6 }, { 0xffff, 21 }, { 0xffff, 37 },
	    { 0x3fff, 53 },
	/* 0xa18 */ { 0xfffe, 67 }, { 0xf7ff, 82 }, { 0x2e11, 97 },
	    { 0x0000, 0 },
	/* 0xa1c */ { 0x3800, 103 }, { 0x0000, 0 }, { 0x3000, 106 },
	    { 0x4000, 108 },
	/* 0xa20 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa24 */ { 0x1ffe, 109 }, { 0x0000, 0 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xa28 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0040, 121 },
	    { 0x0001, 122 },
	/* 0xa2c */ { 0x0002, 123 }, { 0x0000, 0 }, { 0xffc0, 124 },
	    { 0x7fff, 134 },
	/* 0xa30 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa34 */ { 0xfffe, 149 }, { 0xffff, 164 }, { 0xffff, 180 },
	    { 0x3fff, 196 },
	/* 0xa38 */ { 0xfffe, 210 }, { 0xffff, 225 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xa3c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x4000,
								  241 },
	/* 0xa40 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa44 */ { 0xfffe, 242 }, { 0xffff, 257 }, { 0xffff, 273 },
	    { 0x3fff, 289 },
	/* 0xa48 */ { 0xfffe, 303 }, { 0xffff, 318 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xa4c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa50 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa54 */ { 0xfffe, 334 }, { 0xffff, 349 }, { 0xffff, 365 },
	    { 0x3fff, 381 },
	/* 0xa58 */ { 0x0ffe, 395 }, { 0x0000, 0 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xa5c */ { 0x0000, 0 }, { 0x7c00, 406 }, { 0x0000, 0 },
	    { 0x1e00, 411 },
	/* 0xa60 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa64 */ { 0xfffe, 415 }, { 0xffff, 430 }, { 0xffff, 446 },
	    { 0x3fff, 462 },
	/* 0xa68 */ { 0xe7fe, 476 }, { 0xcfcf, 489 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xa6c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0xffe0, 501 },
	    { 0x7fff, 512 },
	/* 0xa70 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa74 */ { 0xfffe, 527 }, { 0xffff, 542 }, { 0xffff, 558 },
	    { 0x3fff, 574 },
	/* 0xa78 */ { 0xfffe, 588 }, { 0xffff, 603 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xa7c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x7fff,
								  619 },
	/* 0xa80 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa84 */ { 0xfffe, 634 }, { 0xffff, 649 }, { 0xffff, 665 },
	    { 0x3fff, 681 },
	/* 0xa88 */ { 0xfffe, 695 }, { 0xffff, 710 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xa8c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa90 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa94 */ { 0xfffe, 726 }, { 0xffff, 741 }, { 0xffff, 757 },
	    { 0x001f, 773 },
	/* 0xa98 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xa9c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xaa0 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xaa4 */ { 0xfffe, 778 }, { 0xffff, 793 }, { 0xffff, 809 },
	    { 0x3fff, 825 },
	/* 0xaa8 */ { 0xfffe, 839 }, { 0xffff, 854 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xaac */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x7ff0,
								  870 },
	/* 0xab0 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xab4 */ { 0xfffe, 881 }, { 0xffff, 896 }, { 0xffff, 912 },
	    { 0x3fff, 928 },
	/* 0xab8 */ { 0xfffe, 942 }, { 0xffff, 957 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xabc */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0780,
								  973 },
	/* 0xac0 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xac4 */ { 0xfffe, 977 }, { 0xffff, 992 }, { 0xffff, 1008 },
	    { 0x3fff, 1024 },
	/* 0xac8 */ { 0xfffe, 1038 }, { 0x00ff, 1053 }, { 0x0000, 0 },
	    { 0x0000, 0 },
	/* 0xacc */ { 0xfffc, 1061 }, { 0x0001, 1075 }, { 0x0000, 0 },
	    { 0x007c, 1076 },
	/* 0xad0 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0xad4 */ { 0xfffe, 1081 }, { 0xffff, 1096 }, { 0xffff, 1112 },
	    { 0x3fff, 1128 },
	/* 0xad8 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0xfffe, 1142 },
	    { 0x0001, 1157 },
};
