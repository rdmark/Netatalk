...
static const u_int16_t mac_chinese_simp_uni2_page00[][2] = {
	...
	/* 0x00c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x010 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x014 */ { 0x0110, 6 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x018 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x01c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0200,
								  8 },
	/* 0x020 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
...
static const u_int16_t mac_chinese_simp_uni2_page30[][2] = {
	...
	/* 0x304 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x308 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
	/* 0x30c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0800,
								  20 },
};
...
static const u_int16_t mac_chinese_simp_uni2_pageff[][2] = {
	...
	/* 0xff8 */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000,
								  0 },
...
static const u_int16_t mac_chinese_simp_2uni_page00[][2] = {
	/* 0x008 */ { 0x0007, 0 }, { 0x0000, 0 }, { 0x0001, 3 }, { 0x0000,
								  0 },
	/* 0x00c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0xe000,
								  4 },
};
...
static const u_int16_t mac_chinese_simp_2uni_pagea3[][2] = {
	...
	/* 0xa3c */ { 0x0000, 0 }, { 0x0000, 0 }, { 0x0000, 0 }, { 0x4000,
								  15 },
};
