...
static size_t mac_japanese_pull(void *, char **, size_t *, char **,
				size_t *);
static size_t mac_japanese_push(void *, char **, size_t *, char **,
				size_t *);
...
static size_t mac_japanese_char_push(u_int8_t * out, const ucs2_t * in,
				     size_t *size)
{
	ucs2_t wc = in[0];
...
static size_t mac_japanese_push(void *cd, char **inbuf,
...
static size_t mac_japanese_char_pull(ucs2_t * out, const u_int8_t * in,
				     size_t *size)
{
	u_int16_t c = in[0];
...
static size_t mac_japanese_pull(void *cd, char **inbuf,
				size_t *inbytesleft, char **outbuf,
				size_t *outbytesleft)
{
