...
extern size_t
cjk_generic_push(size_t (*)(u_int8_t *, const ucs2_t *, size_t *), void *,
		 char **, size_t *, char **, size_t *);
extern size_t
cjk_generic_pull(size_t (*)(ucs2_t *, const u_int8_t *, size_t *), void *,
		 char **, size_t *, char **, size_t *);

extern size_t cjk_char_push(u_int16_t, u_int8_t *);
extern size_t cjk_char_pull(ucs2_t, ucs2_t *, const u_int32_t *);

extern u_int16_t cjk_lookup(u_int16_t, const cjk_index_t *,
			    const u_int16_t *);
