...
const char *AfpNum2name(int num)
{
	...
	case AFP_SETEXTATTR:
		return "AFP_SETEXTATTR";	/* 70 */
	case AFP_REMOVEATTR:
		return "AFP_REMOVEATTR";	/* 71 */
	case AFP_LISTEXTATTR:
		return "AFP_LISTEXTATTR";	/* 72 */
	case AFP_GETACL:
		return "AFP_GETACL";	/* 73 */
	case AFP_SETACL:
		return "AFP_SETACL";	/* 74 */
	case AFP_ACCESS:
		return "AFP_ACCESS";	/* 75 */
	case AFP_SPOTLIGHT_PRIVATE:
		return "AFP_SPOTLIGHT_PRIVATE";	/* 76 */
	case AFP_SYNCDIR:
		return "AFP_SYNCDIR";	/* 78 */
	case AFP_SYNCFORK:
