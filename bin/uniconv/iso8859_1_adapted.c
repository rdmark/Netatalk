...
static size_t iso8859_adapted_pull(void *, char **, size_t *, char **,
				   size_t *);
static size_t iso8859_adapted_push(void *, char **, size_t *, char **,
				   size_t *);
...
static size_t iso8859_adapted_push(void *cd _U_, char **inbuf,
...
/* ------------------------ */
static size_t iso8859_adapted_pull(void *cd _U_, char **inbuf,
				   size_t *inbytesleft, char **outbuf,
				   size_t *outbytesleft)
{
	unsigned char *inptr;
